...
import { AcademicFormPage, AcademicListPage, AcademicViewPage } from './academic/AcademicPages';
...
export default function App() {
    return (
        <Routes>
            ...
            <Route path="/disabled" element={<DisabledStudentsPage />} />
            <Route path="/academic" element={<Navigate to="/classes" replace />} />
            <Route path="/classes" element={<AcademicListPage Layout={AdminLayout} title="Classes" endpoint="/classes" createTo="/classes/create" editBase="/classes" viewBase="/classes" />} />
            ...
            <Route path="/sections" element={<AcademicListPage Layout={AdminLayout} title="Sections" endpoint="/section" createTo="/sections/create" editBase="/sections" viewBase="/sections" />} />
            ...
            <Route path="/subjects" element={<AcademicListPage Layout={AdminLayout} title="Subjects" endpoint="/subject" createTo="/subjects/create" editBase="/subjects" viewBase="/subjects" />} />
            ...
            <Route path="/class-rooms" element={<AcademicListPage Layout={AdminLayout} title="Class Rooms" endpoint="/class-room" createTo="/class-rooms/create" editBase="/class-rooms" viewBase="/class-rooms" />} />
            ...
            <Route path="/subject-assigns" element={<AcademicListPage Layout={AdminLayout} title="Subject Assigns" endpoint="/assign-subject" createTo="/subject-assigns/create" editBase="/subject-assigns" viewBase="/subject-assigns" />} />
            ...
            <Route path="/time-schedules" element={<AcademicListPage Layout={AdminLayout} title="Time Schedules" endpoint="/time/schedule" createTo="/time-schedules/create" editBase="/time-schedules" viewBase="/time-schedules" />} />
            ...
            <Route path="/class-routines" element={<AcademicListPage Layout={AdminLayout} title="Class Routines" endpoint="/class-routine" createTo="/class-routines/create" editBase="/class-routines" viewBase="/class-routines" />} />
            ...
            <Route path="/exam-routines" element={<AcademicListPage Layout={AdminLayout} title="Exam Routines" endpoint="/exam-routine" createTo="/exam-routines/create" editBase="/exam-routines" viewBase="/exam-routines" />} />
            ...
            <Route path="/accounts" element={<AccountsHomePage Layout={AdminLayout} />} />
            <Route path="/accounts/chart-of-accounts" element={<ChartOfAccountsPage Layout={AdminLayout} />} />
            <Route path="/accounts/chart-of-accounts/create" element={<ChartOfAccountsFormPage Layout={AdminLayout} />} />
            <Route path="/accounts/chart-of-accounts/:id/edit" element={<ChartOfAccountsFormPage Layout={AdminLayout} edit />} />
            <Route path="/accounts/payment-methods" element={<PaymentMethodsPage Layout={AdminLayout} />} />
            <Route path="/accounts/payment-methods/create" element={<PaymentMethodFormPage Layout={AdminLayout} />} />
            <Route path="/accounts/payment-methods/:id/edit" element={<PaymentMethodFormPage Layout={AdminLayout} edit />} />
            <Route path="/accounts/account-heads" element={<AccountHeadsPage Layout={AdminLayout} />} />
            <Route path="/accounts/account-heads/create" element={<AccountHeadFormPage Layout={AdminLayout} />} />
            <Route path="/accounts/account-heads/:id/edit" element={<AccountHeadFormPage Layout={AdminLayout} edit />} />
            <Route path="/accounts/income" element={<IncomePage Layout={AdminLayout} />} />
            <Route path="/accounts/income/create" element={<IncomeFormPage Layout={AdminLayout} />} />
            <Route path="/accounts/income/:id/edit" element={<IncomeFormPage Layout={AdminLayout} edit />} />
            <Route path="/accounts/expense" element={<ExpensePage Layout={AdminLayout} />} />
            <Route path="/accounts/expense/create" element={<ExpenseFormPage Layout={AdminLayout} />} />
            <Route path="/accounts/expense/:id/edit" element={<ExpenseFormPage Layout={AdminLayout} edit />} />
            ...
            <Route path="/accounts/cash" element={<CashPage Layout={AdminLayout} />} />
            <Route path="/accounts/product" element={<ProductPage Layout={AdminLayout} />} />
            <Route path="/accounts/product/create" element={<ProductCreatePage Layout={AdminLayout} />} />
            <Route path="/accounts/product/sell" element={<ProductSellPage Layout={AdminLayout} />} />
            <Route path="/accounts/item" element={<ItemPage Layout={AdminLayout} />} />
            <Route path="/accounts/item/create" element={<ItemCreatePage Layout={AdminLayout} />} />
            <Route path="/accounts/balance" element={<BalancePage Layout={AdminLayout} />} />
            ...
            <Route path="/reports/accounting/dashboard" element={<AccountingDashboardPage Layout={AdminLayout} />} />
            ...
            <Route
                path="/reports/fees-by-year/:studentId"
                element={<ReportEntryPage title="Fees by year — student detail" endpointTemplate="/report-fees-by-year/detail/:studentId" />}
            />
            ...
            <Route path="/fees/transactions" element={<FeesTransactionsPage Layout={AdminLayout} />} />
            <Route path="/fees/online-transactions" element={<FeesOnlineTransactionsPage Layout={AdminLayout} />} />
            <Route path="/fees/amendments" element={<FeesAmendmentsPage Layout={AdminLayout} />} />
