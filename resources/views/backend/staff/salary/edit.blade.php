...
@section('content')
    <div class="page-content">
        ...
        <div class="card ot-card">
            <div class="card-body">
                <form action="{{ route('salary.update', @$data['department']->id) }}" enctype="multipart/form-data" method="post"
                    id="visitForm">
                    @csrf
                    @method('PUT')
                    <div class="row mb-3">
                        <div class="col-lg-12">
                            <div class="row">
                                <div class="col-md-6 mb-3">
                                    ...
                                    <input class="form-control ot-input @error('name') is-invalid @enderror" disabled name="name"
                                        value="{{ old('name',@$data['department']->first_name) }} {{ old('name',@$data['department']->last_name) }}" list="datalistOptions" id="exampleDataList" type="text"
                                ...
                                <div class="col-md-6 mb-3">
                                    <label for="exampleDataList" class="form-label ">{{ 'Amount' }}<span
                                                class="fillable">*</span></label>
                                    <input class="form-control ot-input @error('name') is-invalid @enderror" disabled name="name"
                                           value="{{ old('name',@$data['department']->amount) }} " list="datalistOptions" id="exampleDataList" type="text"
                                           placeholder="{{ ___('common.enter_name') }}">
                                    @error('name')
                                    <div id="validationServer04Feedback" class="invalid-feedback">
                                        {{ $message }}
