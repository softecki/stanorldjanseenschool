...
@section('content')
    <div class="page-content">
                ...
                <div class="col-sm-6">
                    ...
                    <ol class="breadcrumb">
                        ...
                        <li class="breadcrumb-item" aria-current="page"><a
                                href="{{ route('salary.index') }}">{{ $data['title'] }}</a></li>
        ...
        <div class="card ot-card">
            <div class="card-body">
                <form action="{{ route('salary.store') }}" enctype="multipart/form-data" method="post" id="visitForm">
                    @csrf
                    <div class="row mb-3">
                        <div class="col-lg-12">
                            <div class="row">
                                <div class="col-md-6 mb-3">
                                    <label for="exampleDataList" class="form-label ">{{ 'Batch Month' }} <span
                                            class="fillable">*</span></label>
                                    <input class="form-control ot-input @error('name') is-invalid @enderror" name="name"
                                        list="datalistOptions" id="exampleDataList" type="text"
                                        placeholder="{{ ___('common.enter_name') }}" value="{{ $data['batch_date'] }}">
                                    @error('name')
