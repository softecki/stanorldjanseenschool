                    ...
                    <div class="d-flex justify-content-between align-items-center flex-wrap">
                        <div class="mb-3 mb-md-0">
                            <h4 class="bradecrumb-title mb-2">
                                <i class="fa-solid fa-pen-to-square me-2"></i>{{ $data['title'] }}
                            </h4>
                ...
                <div class="card-header">
                    <div class="section-header-content">
                        ...
                        <div>
                            ...
                            <p class="mb-0">Update the student's personal details</p>
                        </div>
                    </div>
                </div>
                <div class="card-body">
                        ...
                        <div class="col-md-4 mb-4">
                            ...
                            <select class="form-select modern-input @error('gender') is-invalid @enderror"
                                ...
                                @foreach ($data['genders'] as $item)
                                    <option {{ @$data['student']->gender_id == $item->id ? 'selected' : '' }} value="{{ $item->id }}">{{ $item->name }}</option>
                                @endforeach
                            </select>
                            @error('gender')
                                <div class="invalid-feedback">
                        ...
                        <div class="col-md-4 mb-4">
                            ...
                            <select class="form-select modern-input @error('category') is-invalid @enderror"
                                ...
                                @foreach ($data['categories'] as $item)
                                    <option {{ @$data['student']->student_category_id == $item->id ? 'selected' : '' }} value="{{ $item->id }}">{{ $item->name }}</option>
                                @endforeach
                            </select>
                            @error('category')
                                <div class="invalid-feedback">
                ...
                <div class="card-header">
                    <div class="section-header-content">
                        ...
                        <div>
                            ...
                            <p class="mb-0">Update class, section and status</p>
                        </div>
                    </div>
                </div>
                <div class="card-body">
                    <div class="row">
                        <div class="col-md-4 mb-4">
                            ...
                            <select id="getSections" required
                                ...
                                @foreach ($data['classes'] as $item)
                                    <option {{ @$data['session_class_student']->classes_id == $item->class->id ? 'selected' : '' }} value="{{ $item->class->id }}">{{ $item->class->name }}</option>
                                @endforeach
                            </select>
                            @error('class')
                                <div class="invalid-feedback">
                        ...
                        <div class="col-md-4 mb-4">
                            <label for="status" class="form-label">
                                <i class="fa-solid fa-toggle-on text-info me-2"></i>{{ ___('common.status') }} 
                                <span class="required-star">*</span>
                            </label>
                            <select class="form-select modern-input @error('status') is-invalid @enderror"
                                name="status" id="status" required>
                                <option {{ @$data['student']->status == App\Enums\Status::ACTIVE ? 'selected' : '' }} value="{{ App\Enums\Status::ACTIVE }}">{{ ___('common.active') }}</option>
                                <option {{ @$data['student']->status == App\Enums\Status::INACTIVE ? 'selected' : '' }} value="{{ App\Enums\Status::INACTIVE }}">{{ ___('common.inactive') }}</option>
                            </select>
                            @error('status')
                                <div class="invalid-feedback">
                                    <i class="fa-solid fa-circle-exclamation me-1"></i>{{ $message }}
                ...
                <div class="card-header">
                    <div class="section-header-content">
                        ...
                        <div>
                            ...
                            <p class="mb-0">Update contact and parent details</p>
                        </div>
                    </div>
                </div>
                <div class="card-body">
                    <div class="row">
                        <div class="col-md-4 mb-4">
                            <label for="mobile" class="form-label">
                                <i class="fa-solid fa-mobile-screen-button text-primary me-2"></i>{{ ___('student_info.mobile') }}
                            </label>
                        ...
                        <div class="col-md-4 mb-4">
                            <label for="parent" class="form-label">
                                <i class="fa-solid fa-user-friends text-warning me-2"></i>{{ ___('student_info.select_parent') }} 
                                <span class="required-star">*</span>
                            </label>
                            <select class="form-select parent modern-input @error('parent') is-invalid @enderror"
                            ...
                            <div class="action-buttons-wrapper">
                                ...
                                <div class="action-buttons">
                                    ...
                                    <button type="submit" class="btn btn-outline-primary btn-lg">
                                        <i class="fa-solid fa-save me-2"></i>{{ ___('common.update') ?? 'Update' }}
                                    </button>
                                </div>
                            </div>
                        </div>
