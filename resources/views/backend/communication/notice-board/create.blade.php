...
@section('content')
    <div class="page-content">
        ...
        <div class="card ot-card">
            <div class="card-body">
                <form action="{{ route('notice-board.store') }}" enctype="multipart/form-data" method="post" id="markRegister">
                    @csrf
                    <div class="row mb-3">
                        <div class="col-lg-12">
                            <div class="row">
                                ...
                                <div class="col-md-4 mb-3">
                                    ...
                                    <input class="form-control ot-input @error('publish_date') is-invalid @enderror" name="publish_date" type="datetime-local"
                                        ...
                                        placeholder="{{ ___('common.publish_date') }}" value="{{ old('publish_date') }}">
                                    @error('publish_date')
                                        <div id="validationServer04Feedback" class="invalid-feedback">
                                            {{ $message }}
                                        </div>
                                ...
                                <div class="col-md-4 mb-3">
                                    <label class="form-label">{{ ___('academic.is_visible_web') }} ?<span class="fillable"></span></label>
                                    <div class="input-check-radio academic-section @error('sections') is-invalid @enderror">
                                        <div class="form-check">
                                          <input class="form-check-input" type="radio" name="is_visible_web" value="1"  id="flexCheckDefault-1" />
                                          <label class="form-check-label ps-2 pe-5" for="flexCheckDefault-1">{{ ___('academic.yes') }}</label>
                                        </div>
                                        <div class="form-check">
                                          <input class="form-check-input" type="radio" name="is_visible_web" value="0" checked  id="flexCheckDefault-0" />
                                ...
                                <div class="col-md-12 mb-3">
                                    ...
                                    <div class="input-check-radio academic-section @error('sections') is-invalid @enderror">
                                        ...
                                        <div class="form-check">
                                          <input class="form-check-input" type="checkbox" name="visible_to[]" value="{{ $item->id }}"  id="flexCheckDefault-1" />
