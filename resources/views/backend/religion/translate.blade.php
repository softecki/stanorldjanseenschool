...
@section('content')
    <div class="page-content">
        ...
        <div class="card ot-card">
            <div class="card-body">
                <form action="{{ route('religions.translateUpdate', @$data['religion']->id) }}" enctype="multipart/form-data" method="post"
                    id="visitForm">
                    @csrf
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-12 mb-3">
                                    ...
                                    <input class="form-control ot-input @error('name') is-invalid @enderror" name="name[{{$language->code}}]"
                                        value="{{isset($data['translates'][$language->code][0]) ? $data['translates'][$language->code][0]->name :  @$data['religion']->name}}" list="datalistOptions" id="exampleDataList"
