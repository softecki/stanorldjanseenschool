...
@section('content')
    <div class="page-content">
        ...
        <div class="page-header">
            <div class="row">
                <div class="col-sm-6">
                    <h1 class="bradecrumb-title mb-1">{{ ___('settings.marksheet') }}</h1>
                        <ol class="breadcrumb">
            ...
            @if (@$data['resultData'])
                <div class="col-lg-12">
                    <div class="download_print_btns ">
                        <button class="btn btn-md btn-outline-success" onclick="printDiv('printableArea')">
                            {{___('common.print_now')}}
                            <span><i class="fa-solid fa-print"></i></span>
                        </button>
                        <a class="btn btn-md btn-outline-success" href="{{ route('report-marksheet.pdf-generate', ['id'=>$data['request']->student, 'type'=>$data['request']->exam_type, 'class'=>$data['request']->class, 'section'=>$data['request']->section ]) }}">
                            {{___('common.pdf_download')}}
                            <span><i class="fa-brands fa-dochub"></i></span>
                        </a>
                    </div>
                   
                    <div class="card ot-card mb-12" id="printableArea">
                        ...
                        <div class="routine_wrapper">
                            ...
                            <div class="routine_wrapper_body">
                                <div class="student_info_wrapper">
                                    ...
                                    <div class="student_info_single">
                                        <span>{{'Avarage Marks'}} :</span>
                                        <h5>{{ floor(@$data['resultData']['avg_marks'] + 0.5) }}</h5>                                   </div>
                                    <div class="student_info_single">
                                    ...
                                    <div class="student_info_single">
                                        ...
                                        <h5><h5>{{ @$data['resultData']['total_marks'] }}</h5>
                                        @else
                                        <h5>{{ @$data['resultData']['total_marks'] }}</h5>
                                        @endif
                                    </div>

                                    <div class="student_info_single">
                                        <span>Position :</span>
                                        <h5>{{ @$data['resultData']['position'] }}</h5>
                                    </div>

                                    <div class="student_info_single">
                                        <span>Out of :</span>
                                        <h5>{{ @$data['resultData']['max_position'] }}</h5>
                                    </div>
                                        ...
                                        <tbody>
                                            @forelse (@$data['resultData']['marks_registers'] as $item)
                                             @php
                                                                $n = 0;
                                                            @endphp
                                                            @foreach ($item->marksRegisterChilds as $child)
                                                                    @php
                                                                        $n += $child->mark;
                                                                    @endphp
                                                            @endforeach
