...
<div class="page-content">
    ...
    <div class="page-header">
        <div class="row">
            <div class="col-sm-6">
                <h4 class="bradecrumb-title mb-1">{{ ___('settings.due_fees') }}</h1>
                    <ol class="breadcrumb">
                        <li class="breadcrumb-item"><a href="javascript:void(0)">{{ ___('common.home') }}</a></li>
                        <li class="breadcrumb-item">{{ ___('settings.due_fees') }}</li>
                    </ol>
            </div>
        </div>
    </div>
            ...
            <div class="col-lg-12">
                ...
                <div class="download_print_btns">
                    ...
                    <form action="{{ route('report-due-fees.pdf-generate') }}" method="post">
                        ...
                        <button class="btn btn-lg ot-btn-primary mt-3" type="submit">{{___('common.pdf_download')}} <span><i class="fa-brands fa-dochub"></i></span></button>
                    </form>
                </div>
                @endif
