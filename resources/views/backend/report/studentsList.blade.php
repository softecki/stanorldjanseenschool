...
@section('content')
    <div class="page-content">
        ...
        <div class="page-header">
            <div class="row">
                <div class="col-sm-6">
                    <h1 class="bradecrumb-title mb-1">{{ 'Students List' }}</h1>
                    <ol class="breadcrumb">
        ...
        <div class="row">
            <div class="col-12">
                <form action="{{ route('report-students.search') }}" method="post" id="marksheed" enctype="multipart/form-data">
                    @csrf
                ...
                <div class="col-lg-12">
                    @if (count($data['result']) > 0)
                        <div class="download_print_btns">
                            ...
                            @if(!empty($data['request']))
                                ...
                                <a class="btn btn-md btn-outline-success" href="{{ route('report-students.excel-generate', ['class'=>$data['request']->class]) }}">
                                    {{'Export Excel'}}
                    ...
                    <div class="routine_wrapper" id="printableArea">
                        ...
                        <div class="table-responsive">
                            <table class="table table-bordered mb_3">
                                <thead>
                               ...
                               <th style="font-size: 12px;">{{'Status'}}</th>
                                ...
                                @forelse ($data['result'] as $key=>$item)
                                    <tr style="font-size: 12px;">
                                        ...
                                        <td style="font-size: 12px;">{{ $item->section_name }} </td>                                     
