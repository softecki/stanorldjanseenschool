    ...
    <div class="row">
        <div class="col-lg-12">
            <div class="report">
                    ...
                    <table style="width: 100%; border-collapse: collapse;">
                        <tr>
                            ...
                            <td style="width: 55%; vertical-align: middle; color: #000000;">
                                ...
                                <p style="margin: 4px 0; font-size: 14px; color: #000000; font-weight: 700; line-height: 1.3;">P.O.BOX 11 ARUSHA TANZANIA</p>
                                <p style="margin: 4px 0; font-size: 14px; color: #000000; font-weight: 700; line-height: 1.3;">Phone: 0753268400 / 0686268400</p>
                                <p style="margin: 6px 0 0 0; font-size: 14px; color: #000000; font-weight: 700;">Transaction Receipt</p>
                            </td>
                ...
                <div style="background: #F8F9FA; padding: 12px 15px; border-radius: 8px; margin-bottom: 5px; border-left: 4px solid #392C7D;">
                    <table style="width: 100%; border-collapse: collapse;">
                        <tr>
                ...
                <div style="background: white; padding: 12px 15px; border-radius: 8px; margin-bottom: 5px; border: 1px solid #E0E0E0; border-left: 4px solid #392C7D;">
                    <table style="width: 100%; border-collapse: collapse;">
                        <thead>
                ...
                <div style="background: #F8F9FA; padding: 12px 15px; border-radius: 8px; margin-bottom: 15px; text-align: center; border-left: 4px solid #392C7D;">
                ...
                <!-- Footer -->
                <div class="footer">
                    <p style="margin: 0; font-size: 14px; font-weight: 700; color: #000000;">{{ $data['printedby'] }}</p>
                    <p style="margin: 0; font-size: 14px; font-weight: 700; color: #000000;">{{ setting('footer_text') }}</p>
                </div>
        </div>
        </div>
    </div>
