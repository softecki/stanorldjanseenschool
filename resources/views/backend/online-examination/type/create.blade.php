                ...
                <div class="col-sm-6">
                    ...
                    <ol class="breadcrumb">
                        ...
                        <li class="breadcrumb-item" aria-current="page"><a
                                href="{{ route('online-exam-type.index') }}">{{ $data['title'] }}</a></li>
                        ...
                        <div class="col-lg-12">
                            <div class="row">
                                ...
                                @foreach($data['classes']  as $class)
                                    <div class="col-md-3">
                                        <input type="checkbox" name="classes[]" value="{{ $class['id'] }}" id="class_{{ $class['id'] }}">
                                        <label class="form-label" for="class_{{ $class['id'] }}">{{ $class['name'] }}</label>
                                    </div>
                                @endforeach
