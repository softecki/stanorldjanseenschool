...
<div class="page-content">
    ...
    <div class="card">
        <div class="card-header">
            ...
            <p class="mb-0 text-muted">{{ __('Total Other Income') }}: {{ number_format($data['total'] - $data['fees_in_period'], 0) }} | {{ __('Fees in Period') }}: {{ number_format($data['fees_in_period'], 0) }} | <strong>{{ __('Grand Total') }}: {{ number_format($data['total'], 0) }}</strong></p>
        </div>
        <div class="card-body">
