                ...
                <div class="col-sm-6">
                    ...
                    <ol class="breadcrumb">
                        ...
                        <li class="breadcrumb-item" aria-current="page"><a
                                href="{{ route('income.index') }}">{{ ___('settings.income') }}</a></li>
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-6">
                                    ...
                                    @foreach ($data['heads'] as $item)
                                        <option value="{{ $item->id }}" {{ old('income_head') == $item->id ? 'selected' : '' }}>{{ $item->name }}</option>
                                    @endforeach
                                    </select>
                                </div>
                                @error('income_head')
                                ...
                                <div class="col-md-6 mb-3">
                                    <label for="bank_account_id" class="form-label">{{ __('Bank Account') }} ({{ __('receives this income') }}) <span class="fillable">*</span></label>
                                ...
                                <div class="col-md-6 mb-3">
                                    ...
                                    <input class="form-control ot-input @error('bank_name') is-invalid @enderror" name="bank_name" type="text"
                                           value="{{ old('bank_name') }}" list="datalistOptions" id="exampleDataList"
