            ...
            <div class="row">
                <div class="col-sm-6">
                    ...
                    <ol class="breadcrumb">
                        ...
                        <li class="breadcrumb-item"><a href="{{ route('income.index') }}">{{ $data['title'] }}</a></li>
                            ...
                            <div class="row">
                                <div class="col-md-6 mb-3">
                                    ...
                                    <input class="form-control ot-input @error('name') is-invalid @enderror" name="name"
                                        value="{{ old('name',@$data['income']->name) }}" list="datalistOptions" id="exampleDataList"
                                ...
                                <div class="col-md-6">
                                    ...
                                    <select class="nice-select niceSelect bordered_style wide @error('income_head') is-invalid @enderror"
                                    name="income_head" id="validationServer04"
                                    aria-describedby="validationServer04Feedback">
                                        @foreach ($data['heads'] as $item)
                                            <option value="{{ $item->id }}" {{ old('income_head',@$data['income']->income_head) == $item->id ? 'selected' : '' }}>{{ $item->name }}</option>
                                        @endforeach
                                    </select>
                                </div>
                                @error('income_head')
                                ...
                                <div class="col-md-6 mb-3">
                                    ...
                                    <input class="form-control ot-input @error('date') is-invalid @enderror" name="date" type="date"
                                        value="{{ old('date',@$data['income']->date) }}" list="datalistOptions" id="exampleDataList"
                                ...
                                <div class="col-md-6 mb-3">
                                    ...
                                    <input class="form-control ot-input @error('invoice_number') is-invalid @enderror" name="invoice_number"
                                        value="{{ old('invoice_number',@$data['income']->invoice_number) }}" list="datalistOptions" id="exampleDataList"
                                ...
                                <div class="col-md-6 mb-3">
                                    ...
                                    <input class="form-control ot-input @error('amount') is-invalid @enderror" name="amount" type="number"
                                        value="{{ old('amount',@$data['income']->amount) }}" list="datalistOptions" id="exampleDataList"
                                ...
                                <div class="col-md-6 mb-3">
                                    ...
                                    <select class="form-control ot-input @error('bank_account_id') is-invalid @enderror" name="bank_account_id" id="bank_account_id">
                                        <option value="">{{ __('Select account') }}</option>
                                        @isset($data['bank_accounts'])
                                            @foreach ($data['bank_accounts'] as $account)
                                                <option value="{{ $account->id }}" {{ old('bank_account_id', $data['income']->bank_account_id ?? '') == $account->id ? 'selected' : '' }}>{{ $account->bank_name }} - {{ $account->account_number }}</option>
                                            @endforeach
                                        @endisset
                                    </select>
                                ...
                                <div class="col-md-6 mb-3">
                                    ...
                                    <input class="form-control ot-input @error('account_number') is-invalid @enderror" name="account_number" type="text"
                                           value="{{ old('account_number', @$data['income']->account_number) }}"  list="datalistOptions" id="exampleDataList"
                                ...
                                <div class="col-md-6 mb-3">
                                    <label for="exampleDataList" class="form-label ">{{ 'Bank Name' }}</label>
                                    <input class="form-control ot-input @error('bank_name') is-invalid @enderror" name="bank_name" type="text"
                                           value="{{ old('bank_name', @$data['income']->bank_name) }}" list="datalistOptions" id="exampleDataList"
                                ...
                                <div class="col-md-12 mb-3">
                                    ...
                                    placeholder="{{ ___('account.enter_description') }}">{{ old('description',@$data['income']->description) }}</textarea>
                                    @error('description')
                                        <div id="validationServer04Feedback" class="invalid-feedback">
                                            {{ $message }}
                                        </div>
