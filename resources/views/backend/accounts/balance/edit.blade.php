                    ...
                    <div class="row mb-3">
                        <div class="col-lg-12">
                            <div class="row">
                                ...
                                <div class="col-md-6 mb-3">
                                    <label for="exampleDataList" class="form-label ">{{ 'Receivers Number' }} </label>
                                ...
                                <div class="col-md-6 mb-3">
                                    ...
                                    <input class="form-control ot-input @error('account_number') is-invalid @enderror" name="account_number" type="text"
                                           value="{{ old('account_number',@$data['expense']->account_number) }}"  list="datalistOptions" id="exampleDataList"
                                ...
                                {{-- <div class="col-md-6 mb-3">
                                    ...
                                    <input class="form-control ot-input @error('bank_name') is-invalid @enderror" name="bank_name" type="text"
                                           value="{{ old('amount',@$data['income']->bank_name) }}" list="datalistOptions" id="exampleDataList"
                                ...
                                <div class="col-md-6">
                                    <label for="validationServer04" class="form-label">{{ 'Expenses Status' }} <span
                                        class="fillable">*</span></label>
                                    ...
                                    aria-describedby="validationServer04Feedback">
                                        @foreach ($data['status'] as $item)
                                            <option value="{{ $item->id }}" {{ old('expense_head',@$data['expense']->status_name) == $item->id ? 'selected' : '' }}>{{ $item->status_name }}</option>
                                        @endforeach
                                    </select>
                                </div>
