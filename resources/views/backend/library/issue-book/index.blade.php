            ...
            <div class="card">
                <div class="card-header d-flex justify-content-between align-items-center">
                    ...
                    @if (hasPermission('issue_book_create'))
                        <a href="{{ route('issue-book.create') }}" class="btn btn-md btn-outline-primary">
                                ...
                                <tr id="row_{{ $row->id }}">
                                    ...
                                    <td>
                                        @if ($row->status == App\Enums\Status::ACTIVE)
                                            <span class="badge-basic-success-text">{{ 'In Library' }}</span>
                                        @else
                                    ...
                                    @if ((hasPermission('issue_book_update') || hasPermission('issue_book_delete')) || @$row->status == App\Enums\IssueBook::ISSUED)
                                        <td class="action">
                                            @if (@$row->status == App\Enums\IssueBook::ISSUED)
                                                    <a class="btn btn-sm btn-outline-warning" href="#" onclick="showConfirmation('{{ route('issue-book.return', $row->id) }}')">
