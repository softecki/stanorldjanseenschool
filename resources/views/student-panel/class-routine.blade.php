                ...
                <div class="routine_wrapper" id="printableArea">
                    <div class="routine_wrapper_header">
                        ...
                        <div class="routine_wrapper_header_content">
                            <h3>{{ ___('settings.class') }} {{ $className }} {{ ___('settings.routine') }}</h3>
                            <p>{{ ___('settings.section') }} {{ $sectionName }}</p>
                        </div>
                    </div>
                            ...
                            <thead>
                                <tr>
                                    ...
                                    @foreach ($timeSchedules as $timeSchedule)
                                        <th>{{ \Carbon\Carbon::parse($timeSchedule->start_time)->format('h:i A') }} - {{ \Carbon\Carbon::parse($timeSchedule->end_time)->format('h:i A') }}</th>
                                    @endforeach
                                </tr>
                            </thead>
                            <tbody>
