            ...
            <div class="row">
                <div class="col-sm-6">
                    ...
                    <ol class="breadcrumb">
                        ...
                        <li class="breadcrumb-item"><a href="{{ route('gallery.index') }}">{{ $data['title'] }}</a></li>
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-6">
                                    ...
                                    aria-describedby="validationServer04Feedback">
                                        ...
                                        @foreach ($data['categories'] as $item)
                                            <option value="{{ $item->id }}" {{ old('category',@$data['gallery']->gallery_category_id) == $item->id ? 'selected' : '' }}>{{ $item->name }}</option>
                                        @endforeach
                                    </select>
                                    @error('category')
                                ...
                                <div class="col-md-6">
                                    <label for="exampleDataList"
                                        class="form-label ">{{ ___('common.image') }} {{ ___('common.(335 x 405 px)') }}</label>
