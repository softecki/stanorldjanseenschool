...
@section('content')
    <div class="page-content">
        ...
        <div class="card ot-card">
            <div class="card-body">
                <form action="{{ route('page.update',$data['page']->id) }}" enctype="multipart/form-data" method="post" id="visitForm">
                    @csrf
                    <div class="row">
                        <div class="col-md-6 mb-3">
                            ...
                            <input class="form-control ot-input @error('name') is-invalid @enderror" name="name"
                                value="{{ $data['page']->name }}" list="datalistOptions" id="exampleDataList"
                        ...
                        <div class="col-md-3 mb-3">
                            ...
                            aria-describedby="validationServer04Feedback">
                                <option @if($data['page']->menu_show == "header") selected @endif  value="header">{{ ___('common.header') }}</option>
                                <option @if($data['page']->menu_show == "footer") selected @endif  value="footer">{{ ___('common.footer') }}
                                </option>
                            </select>
                            @error('menu_show')
                                <div id="validationServer04Feedback" class="invalid-feedback">
                        ...
                        <div class="col-md-3 mb-3">
                            ...
                            aria-describedby="validationServer04Feedback">
                                <option value="1" @if($data['page']->active_status == 1) selected @endif >{{ ___('common.active') }}</option>
                                <option value="0" @if($data['page']->active_status == 0) selected @endif >{{ ___('common.inactive') }}
                                </option>
                            </select>
                            @error('active_status')
                                <div id="validationServer04Feedback" class="invalid-feedback">
                        ...
                        <div class="col-md-12 mb-3">
                            ...
                            placeholder="{{ ___('common.Enter description') }}">{{$data['page']->content }}</textarea>
                            @error('content')
                                <div id="validationServer04Feedback" class="invalid-feedback">
                                    {{ $message }}
                                </div>
