...
@section('content')
    <div class="page-content">
        ...
        <div class="card ot-card">
            <div class="card-body">
                <form action="{{ route('contact-info.translate.update', @$data['contact_info']->id) }}" enctype="multipart/form-data" method="post"
                    id="visitForm">
                    @csrf
                    @method('PUT')
                    <div class="row mb-3">
                                ...
                                <div class="row mb-3">
                                    <div class="col-md-12">
                                        ...
                                        <input class="form-control ot-input @error('name') is-invalid @enderror" name="name[{{$language->code}}]"
                                            value="{{isset($data['translates'][$language->code][0]) ? $data['translates'][$language->code][0]->name :  @$data['contact_info']->name}}" list="datalistOptions" id="exampleDataList"
                                    ...
                                    <div class="col-md-12">
                                        ...
                                        <input class="form-control ot-input @error('address') is-invalid @enderror" name="address[{{$language->code}}]"
                                            value="{{isset($data['translates'][$language->code][0]) ? $data['translates'][$language->code][0]->address :  @$data['contact_info']->address}}" list="datalistOptions" id="exampleDataList"
                                            placeholder="{{ ___('common.enter_name') }}">
                                        @error('address ')
                                            <div id="validationServer04Feedback" class="invalid-feedback">
                                                {{ $message }}
