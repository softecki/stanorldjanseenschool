...
var activeschool   = parseInt($("#active-school").val());
var inactiveschool = parseInt($("#inactive-school").val());
...
var optionDonut2 = {
    ...
    series: [activeschool, inactiveschool],
    colors: ['#FF951A', '#392C7D'],
    labels: [
        "Active School ",
        "Inactive School",
    ],
