...
function revenueChart() {
    ...
    if($("#ot-line-chart-income").length){
        const lineChartIncome = new ApexCharts(
            document.querySelector("#ot-line-chart-income"),
            {
                ...incomeChart,
                stroke: {
                    colors: "#5669ff",
    ...
    if($("#ot-line-chart-expense").length){
        const lineChartExpense = new ApexCharts(
            document.querySelector("#ot-line-chart-expense"),
            {
                ...expenseChart,
                stroke: {
                    colors: "#00F7BF",
    ...
    if($("#ot-line-chart-revenue").length){
        const lineChartRevenue = new ApexCharts(
            document.querySelector("#ot-line-chart-revenue"),
            {
                ...revenueChart,
                stroke: {
                    colors: "#FF991A",
