...
<body class="{{ @findDirectionOfLang() }} default-theme" dir="{{ @findDirectionOfLang() }}">
    ...
    <div id="layout-wrapper">
        <!-- start header -->
        @include('mainapp::layouts.backend.header')
        <!-- end header -->

        <!-- start sidebar -->
        @include('mainapp::layouts.backend.sidebar')
        <!-- end sidebar -->
        ...
        <main class="main-content ph-24 ph-lg-32 pt-100 mt-4">
            ...
            <!-- start footer -->
            @include('mainapp::layouts.backend.footer')
            <!-- end footer -->
        </main>
    </div>
    ...
    <script src="{{ asset('backend') }}/vendors/apexchart/js/apex-chart.js"></script>
