                ...
                <div class="col-sm-6">
                    ...
                    <ol class="breadcrumb">
                        ...
                        <li class="breadcrumb-item" aria-current="page"><a
                                href="{{ route('testimonial.index') }}">{{ ___('settings.testimonial') }}</a></li>
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-4 mb-3">
                            ...
                            <input class="form-control ot-input @error('link') is-invalid @enderror" name="link"
                                list="datalistOptions" id="exampleDataList"
                                placeholder="{{ ___('common.Enter link') }}" value="{{ old('link') }}">
                            @error('link')
                                <div id="validationServer04Feedback" class="invalid-feedback">
                                    {{ $message }}
                                </div>
                        ...
                        <div class="col-md-4 mb-3">
                            ...
                            <input class="form-control ot-input @error('rating') is-invalid @enderror" name="rating" type="number" min="0" max="5"
                                list="datalistOptions" id="exampleDataList"
                                placeholder="{{ ___('common.Enter rating') }}" value="{{ old('rating') }}">
                            @error('rating')
                                <div id="validationServer04Feedback" class="invalid-feedback">
                                    {{ $message }}
                                </div>
