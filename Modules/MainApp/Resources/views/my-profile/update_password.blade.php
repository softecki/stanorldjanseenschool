            ...
            <div class="d-flex flex-column flex-lg-row gap-4 gap-lg-0">
                                        ...
                                        <ul class="nav flex-column">
                                            <li class="nav-item">
                                                <a class="nav-link active" aria-current="page"
                                                    href="{{ route('profile') }}">{{ ___('common.my_profile') }}</a>
                                            </li>
                                            <li class="nav-item">
                                                <a class="nav-link"
                                                    href="{{ route('password-update') }}">{{ ___('common.update_password') }}</a>
                                            </li>
                                        </ul>
                                    </nav>
                                </div>
                        ...
                        <div class="d-flex align-items-center">
                            ...
                            <div class="flex-grow-1">
                                <div class="body">
                                    ...
                                    <p class="paragraph">{{ ___('common.Super Admin') }}</p>
                                </div>
                            </div>
                        </div>
                    </div>
                ...
                <div class="profile-body">
                    ...
                    <div class="profile-body-form">
                        <form action="{{ route('password-update-store') }}" enctype="multipart/form-data" method="post"
                            id="visitForm">
                            @csrf
                            @method('PUT')
