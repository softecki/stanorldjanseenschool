            ...
            <div class="row">
                <div class="col-sm-6">
                    ...
                    <ol class="breadcrumb">
                        ...
                        <li class="breadcrumb-item">{{ ___('common.Feature List') }}</li>
                    </ol>
                </div>
            </div>
        </div>
        ...
        <div class="table-content table-basic mt-20">
            <div class="card">
                <div class="card-header d-flex justify-content-between align-items-center">
                    <h4 class="mb-0">{{ ___('common.Feature List') }}</h4>
                    {{-- <a href="{{ route('feature.create') }}" class="btn btn-lg ot-btn-primary">
                                            ...
                                            <ul class="dropdown-menu dropdown-menu-end ">
                                                ...
                                                {{-- <li>
                                                    <a class="dropdown-item" href="javascript:void(0);"
                                                        onclick="delete_row('feature/delete', {{ $row->id }})">
