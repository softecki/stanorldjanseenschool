                ...
                <form action="{{ route('subscription.store') }}" enctype="multipart/form-data" method="post"
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-6 mb-3">
                            <label for="validationServer04" class="form-label">{{ ___('common.School') }} <span class="fillable">*</span></label>
                            ...
                            aria-describedby="validationServer04Feedback">
                                <option value="">{{ ___('common.Select School') }}</option>
                        ...
                        <div class="col-md-6 mb-3">
                            <label for="exampleDataList" class="form-label">{{ ___('common.Transaction NO') }} <span
                                    class="fillable"></span></label>
                            <input class="form-control ot-input @error('transaction_no') is-invalid @enderror" name="transaction_no" type="number"
                                list="datalistOptions" id="exampleDataList"
                                placeholder="{{ ___('common.Enter Transaction NO') }}" value="{{ old('transaction_no') }}">
                        ...
                        <div class="col-md-6 mb-3">
                            <label for="validationServer04" class="form-label">{{ ___('common.payment_method') }} <span class="fillable">*</span></label>
                            ...
                            aria-describedby="validationServer04Feedback">
                                <option value="">{{ ___('common.Select payment_method') }}</option>
                                <option value="cash">{{ ___('common.Cash') }}</option>
                                <option value="bank">{{ ___('common.Bank') }}</option>
